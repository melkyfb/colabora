...
// mantidas para paridade com o enum original do upstream; não usadas no fluxo atual
// (noUnusedLocals do projeto exige a leitura; void não altera comportamento)
void IME_STATUS_START
void IME_STATUS_FINISHED
